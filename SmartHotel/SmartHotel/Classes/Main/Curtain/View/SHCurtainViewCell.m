...
- (IBAction)openCurtain {
    ...
    if (self.curtain.curtainType) {  // 通用开关
        ...
        Byte controlData[2] = {self.curtain.openChannelNO, 0XFF};
        ...
        Byte controlData_G4[4] = {self.curtain.openChannelNO, 100, 0, 0};
        ...
        Byte controlData_G3[2] = {self.curtain.openChannelNO, 100};
...
- (IBAction)stopCurtain {
    ...
    if (self.curtain.curtainType) {  // 通用开关
        ...
        Byte controlData[2] = {self.curtain.stopChannelNO, 0XFF};
        ...
        // G4 == 三路 独立的窗帘停止通道
        if (self.curtain.stopChannelNO) {
            
            Byte controlData[4] = {self.curtain.stopChannelNO, 100, 0, 0}; // 这种类型的停止必须给100
            ...
            // G4 == 两路
            Byte controlData_G4[4] = {(self.currentStatus == SHShadeStatusOpen) ? self.curtain.openChannelNO : self.curtain.closeChannelNO, 0, 0, 0};
            ...
            // 兼容G3
            Byte controlData_G3[2] = {(self.currentStatus == SHShadeStatusOpen) ? self.curtain.openChannelNO : self.curtain.closeChannelNO, 0};
...
- (IBAction)closeCurtain {
    ...
    if (self.curtain.curtainType) {  // 通用开关
        ...
        Byte controlData[2] = {self.curtain.closeChannelNO, 0XFF};
        
        [[SHUdpSocket shareSHUdpSocket] sendDataWithOperatorCode:0XE01C targetSubnetID:self.curtain.subnetID targetDeviceID:self.curtain.deviceID additionalContentData:[NSMutableData dataWithBytes:controlData length:sizeof(controlData)] remoteMacAddress:([SHUdpSocket getRemoteControlMacAddress]) needReSend:NO];
        
    } else {
        
        Byte controlData_G4[4] = {self.curtain.closeChannelNO, 100, 0, 0};
        ...
        Byte controlData_G3[2] = {self.curtain.closeChannelNO, 100};
